...
const form = useForm({
    ...
    github_link: props.projeto.github_link,
    prioridade: props.projeto.prioridade,      
    visibilidade: props.projeto.visibilidade,  
    status: props.projeto.status,        
    data_fim: props.projeto.data_fim,            
});
        ...
        <div class="max-w-5xl mx-auto p-6">
            ...
            <div class="card bg-base-100 shadow-md border border-base-200">
                ...
                <div class="card-body p-6">
                    ...
                    <form @submit.prevent="form.post(`/projeto/editar/${props.projeto.id}`)" class="space-y-6">
                        <!-- GRID 2 COLUNAS -->
                        ...
                        <div class="form-control">
                            ...
                            <textarea v-model="form.descricao" class="textarea textarea-bordered w-full outline-0" rows="5"
                                placeholder="Descreva o projeto, objetivos e escopo..."></textarea>
                            <p v-if="form.errors.descricao" class="text-error text-sm mt-1">{{ form.errors.descricao
                                }}</p>
                        </div>
