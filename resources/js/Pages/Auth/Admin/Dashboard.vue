    ...
    <Layout>
        ...
        <div class="grid grid-cols-12 gap-x-6">
            <div class="col-span-12 xl:col-span-4 md:col-span-6">
                <Link href="/admin/cadastrar/usuario">
                    <div class="card">
                            ...
                            <div class="flex items-center justify-between gap-3 flex-wrap">
                                <h3 class="font-light flex items-center mb-0">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round"
                                        class="lucide lucide-folder-check-icon lucide-folder-check">
                                        <path
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <tbody>
                                    <tr class="unread">
                                        <td>
                                            <img class="rounded-full max-w-10" style="width: 40px" :src="avatar - 1"
                                                alt="activity-user" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="#!"
                                                class="badge bg-theme-bg-2 text-white text-[12px] mx-2">Rejeitar</a>
