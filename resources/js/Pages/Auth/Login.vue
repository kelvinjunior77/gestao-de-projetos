          ...
          <div class="card sm:my-12  w-full shadow-none">
            <div class="card-body !p-10">
              ...
              <form @submit.prevent="login.post('/login')" >
                <div class="mb-3">
                  <input type="email" v-model="login.email" class="form-control" id="floatingInput" placeholder="Email Address" />
                </div>
                <div class="mb-4">
                  <input type="password" v-model="login.password" class="form-control" id="floatingInput1" placeholder="Password" />
                </div>
              ...
              <div class="flex justify-between items-end flex-wrap mt-4">
                <h6 class="font-medium mb-0">Não tem uma conta?</h6>
                <a href="register-v1.html" class="text-primary-500">Criar Conta</a>
              </div>
            </div>
          </div>
        </div>
