...
<template>
  <div class="min-h-screen flex items-center justify-center bg-base-200 relative overflow-hidden">
    ...
    <!-- EFEITOS DECORATIVOS -->
    <span class="absolute top-[-120px] right-[-120px] w-[280px] h-[280px] rounded-full bg-primary/20 blur-xl opacity-40 animate-pulse"></span>
    <span class="absolute bottom-[-120px] left-[-120px] w-[280px] h-[280px] rounded-full bg-secondary/20 blur-xl opacity-40 animate-pulse"></span>
